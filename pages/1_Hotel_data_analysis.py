...
code7 = '''# Decision Tree classifier the review category of hotels based on the two features (number of reviews and price)
...
code8 = '''# Initialize the Decision tree model
